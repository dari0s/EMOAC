...
print("2. Ingresar dos subestaciones (barras) y calcular la distancia entre ellas")
opcion = input("Ingrese 1 o 2: ").strip()

# Referencia -> Territorio Nacional (Quitar Fondo)

mapa = folium.Map(location=[-35.5, -71.5], zoom_start=6, tiles=None)

# folium _> Contorno Territorio (bN)
...
output_txt = 'Mapa_01.html'
mapa.save(output_txt)
print("Mapa generado y guardado como: ", output_txt)
